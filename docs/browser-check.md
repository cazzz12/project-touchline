...
## Vervolg: accounts en multiplayerproef (0.19.0, 26 september 2026)

- Aparte testserver op 43143, eigen SQLite-testdatabase en twee testaccounts: Ajax en PSV. De bestaande Ajax-carrière op 3000 is niet gebruikt om spelacties te testen.
- Inlogcode aanvragen, invoeren, uitloggen en terugkeren naar hetzelfde account werken via de interface. Een competitie aangemaakt en met een tweede manager via de code deelgenomen. De startknop bleef bij één manager geblokkeerd.
- De organisator startte de competitie; Ajax bewaarde 4-4-2 met aanval 65 en trainde Davy Klaassen. De clubkas daalde één keer van 120.000 naar 119.000.
- Na Ajax' gereedmelding bleef de speeldag staan op 1/2 klaar. PSV meldde zich daarna gereed. De server rekende alle drie duels af: Ajax 1–2 FC Twente, Feyenoord 2–2 FC Utrecht en PSV 1–1 AZ. Beide accounts zagen dezelfde ranglijst en uitslagen.
- PSV bood 10.000 spelcredits op Marc ter Stegen. Het bod kostte nog niets. Ajax zag het ontvangen bod, accepteerde de verkoop en ontving de credits. Het bod verdween; Ajax' selectie kreeg een geldige vervangende keeper. Ajax had daarna 139.000 credits.
- Herladen behield het account en de competitie. Vervolgens is de testserver echt gestopt en opnieuw gestart op dezelfde database. De volledige zichtbare competitietekst was daarna exact gelijk.
- Desktop en mobiel 390 × 844 bekeken. Competitie en selectieformulieren pasten horizontaal binnen het scherm; documentbreedte 375 px bij viewport 390 px. Tijdelijke viewport hersteld. Geen fouten in de opgevraagde browserconsole.
- Een probleem waarbij de algemene knoppenhandler formulierverzending onderschepte is tijdens browsercontrole gevonden en opgelost. Een automatische regressietest controleert de normale submitklik. Een tweede UI-test bewaart een onzekere serveropdracht na herladen en herhaalt dezelfde opdrachtcode.
- Hoofdserver op 3000 bijgewerkt en gestart met de nieuwe servercode. Het voortgangsoverzicht van de lokale gebruikerscarrière bleef exact gelijk: Ajax, seizoen 1, 9/10 duels, 27 spelers en 84.666 credits. Multiplayer is geopend in een eigen tab, zonder testaccounts in de echte database te maken.
- De backupopdracht heeft een nieuw consistent databasebestand aangemaakt. Databases, backups, tijdelijke testgegevens en omgevingsbestanden zijn uitgesloten van de broncodewijziging.

Alle **247 automatische tests** slagen. De 19 nieuwe tests controleren onder meer codes, browserbinding, verlopen bewijs, accountkoppeling, Ed25519-handtekeningen, sessie-intrekking, CSRF, clubclaims, herhaalde verzoeken, gelijktijdigheid, transacties, selectie-eigendom, training, onderlinge transfers, onvoldoende saldo, rollback, databaseherstart, backup en een volledig seizoen.

Grenzen: dit is een lokaal geteste, beperkte multiplayerproef. Geen externe deployment, echte e-mailbezorging, echte Phantom-wallet, meerdere fysieke apparaten of Solana-betaling getest. De mailtest gebruikt een geïnjecteerd testtransport; de walletproeven gebruiken tijdelijke cryptografische sleutels. De uitgebreide lokale game is nog niet volledig naar multiplayer overgezet. Zie [de precieze omvang en resterende stappen](online.md).
