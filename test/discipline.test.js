...
function makeLegacy(g){for(const key of ['disciplineRules','opponentKeeperMinutes','opponentPlayed','opponentStarted','bookings','dismissed','abandoned'])delete g.pending[key];for(const s of g.pending.stats){delete s.yellowCards;delete s.redCards;}}
