...
function liveModal(){
  ...
  ${full?keeperReportView(report.detail)+fitnessReport(report.medicalReport)+developmentReportView(report.developmentReport)+reputationReportView(report.reputationReport)+leagueMarketNotice(game,true):''}
