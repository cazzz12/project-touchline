...
export function fitnessPanel(game,proposal=null){
  ...
  <p class="muted">Spelblessures worden na een wedstrijd vastgesteld; dit zijn geen berichten over echte spelers. Na iedere speeldag herstel je één dag. Hersteltraining verbetert conditie, maar maakt een geblesseerde speler niet direct inzetbaar.</p>
